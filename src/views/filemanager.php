                ...
                <footer class="footer loading">
                    <div class="left-buttons float-lt">
                        <button class="btn-big-svg btn-icon-reset" data-action="refresh" type="button">
                            <svg fill="none" height="42" viewBox="0 0 60 42" width="60"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="btn-big-svg btn-icon-reset" data-action="add-folder" data-modal="#addFolderModal"
                                type="button">
                            <svg fill="none" height="42" viewBox="0 0 51 42" width="51"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="btn-big-svg btn-icon-reset" data-action="upload" data-modal="#uploadModal"
                                type="button">
                            <svg fill="none" height="42" viewBox="0 0 54 42" width="54"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="right-buttons float-lt">
                        <button class="btn-big-svg btn-icon-reset" data-action="edit" data-modal="#editorModal" disabled
                                type="button">
                            <svg fill="none" height="42" viewBox="0 0 38 42" width="38"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="btn-big-svg btn-icon-reset" data-action="move" data-modal="#moveFileModal"
                                disabled
                                type="button">
                            <svg fill="none" height="42" viewBox="0 0 40 42" width="40"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="btn-big-svg btn-icon-reset" data-action="permissions"
                                data-modal="#permissionsModal"
                                disabled type="button">
                            <svg fill="none" height="42" viewBox="0 0 42 42" width="42"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path clip-rule="evenodd"
                        ...
                        <button class="btn-big-svg btn-icon-reset" data-action="info" data-modal="#infoFileModal"
                                disabled
                                type="button">
                            <svg fill="none" height="42" viewBox="0 0 42 42" width="42"
                                 xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal-body">
                    <ul class="info-list">
                        ...
                        <li class="info-item group">
                            <span class="info-icon">
                                <svg fill="none" height="19" viewBox="0 0 23 19" width="23"
                                     xmlns="http://www.w3.org/2000/svg">
